<section data-background="img/backgrounds/color/samfunn.jpg">
	<h2 class="color-white text-shadow">Ditt avfall</h2>
</section>

<section>
	<div class="clear">
		<div class="grid50">
			<h3>Avfallsmengder</h3>
...
<section>
	...
	<p>SIM starta i mars 2014 og hente plastemballasje og tekstilar frå hushald i Fitjar. Målet med prosjektet var å finna ut om ei slik ordning kan innførast i alle SIM- kommunane. Ein ynskte å teste løysingar, kostnadar og korleis dei ulike avfallsfraksjonane påverkar kvarandre. Emballasjeplast og tekstilar vert henta saman med papiret. I tillegg tok ein vekk 2- tals ordninga, ordninga der abonnentane kan få henta restavfallet annakvar veke mot ekstra betaling.</p>

	<p>Erfaringar viser at ein i løpet av 12 mnd har fått inn 11 tonn tekstilar, om lag 3,6 kg per innbyggjar, og ein har fått inn 9,5 tonn plastemballasje, om lag 3 kg per innbyggjar.</p>
</section>