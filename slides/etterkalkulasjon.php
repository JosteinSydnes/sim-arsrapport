...
<section>
	...
	<table border="0" class="nice-table">
		...
		<tbody>
			...
			<tr>
				<td>Inngåande fond 01.01.2014</td>
				<td>kr 11 040 467</td>
				<td>kr 1 511 149</td>
			</tr>
	...
	<p>Bundne fond i SIM fordelt på abonnentane*</p>
	<p>*(fordelt etter abonnentar per.kommune/hytteabonnentar er rekna som ½ abonnent)</p>

</section>

<section>
	<h3>Hushaldsrenovasjon og slamtømming</h3>

	<table border="0" class="nice-table">
		<thead>
			<tr>
				<th></th>
				<th colspan="2">Hushaldsrenovasjon</th>
				<th colspan="2">Slamtøming</th>
			</tr>
		</thead>
		<tbody>
			<tr>
...
<section>
	...
	<p>Ny forskrift krev ikkje at ein belastar gebyra kalkulatoriske renter. Representantskapet ynskjer ikkje endring i måten selskapet fører sjølvskostrekneskapen på så lenge forskrifta ikkje krev det.</p>
</section>