<section data-background="img/backgrounds/color/miljosentral.jpg">
	<h2 class="color-white text-shadow">Miljøsentralar</h2>
</section>
...
<section>
	<div class="clear">
		...
		<div class="grid50">
			...
			<div class="info-graphic">
				<h4><i class="fa fa-user-plus"></i> <span class="countmeup">16</span> %</h4>
				<p>fleire vitjingar i 2014.</p>
			</div>
		</div>
	</div>
</section>
